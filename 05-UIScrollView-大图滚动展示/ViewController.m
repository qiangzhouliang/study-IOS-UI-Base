//
//  ViewController.m
//  05-UIScrollView-大图滚动展示
//
//  Created by swan on 2024/8/31.
//
...
-(IBAction)srcoll:(UIButton*)sender;
...
//    self.scrollView.delegate = self;
    ...
    for (int i = 0; i < 3; i++) {
        ...
        // 设置图片
        NSString *imgPath = [NSString stringWithFormat:@"banner%d",(i+1)];
...
//    [self.scrollViewBanner bringSubviewToFront:self.pageControl];
...
//    }];
    ...
    // 直接通过动画的方式来设置 contentOffset 属性的值
